 ...
 * Author: Sahil
 *
 * Created on 13 January, 2018, 11:20 AM
 */
...
//#define y1 PORTAbits.RA2
//#define y2 PORTAbits.RA3
...
void main()
{
    ...
    while(1)
    {
        ...
        uart_string1("\r\n");
        __delay_ms(300);
        if((x_cor>=68)&&(x_cor<=220)&&(y_cor>=97)&&(y_cor<=175))
        {
           uart_string1("left");
        }
        else if((x_cor>=178)&&(x_cor<=553)&&(y_cor>=250)&&(y_cor<=573))
        {
           uart_string1("up");
        }
        else if((x_cor<=1000)&&(y_cor>=300)&&(y_cor<=350))
        {
           uart_string1("right");
        }
        else
